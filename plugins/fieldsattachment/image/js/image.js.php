...
ObjImage = new Class({
	...
	initialize: function(id, options) {
        ...
        setunit:function(opt1, opt2, opt3, opt4)
        {
            ...
            jQuery('select#jform_params_field_selectable2').val(opt4); 
            jQuery("select#jform_params_field_selectable2").trigger("liszt:updated");

            jQuery('select#jform_params_field_filter').val(opt3); 
            jQuery("select#jform_params_field_filter").trigger("liszt:updated");

          

           //alert(jQuery('select#jform_params_field_selectable2').val());
