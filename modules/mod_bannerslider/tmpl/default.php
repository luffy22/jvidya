...
$document->addStyleSheet(JURI::root()."modules/mod_bannerslider/assets/css/banner_slider.css");
if($params->get('loadjs') == 1)
$document->addScript('http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js');
//$document->addScript(JURI::root()."modules/mod_bannerslider/assets/js/cycle.js");

require_once JPATH_ROOT . '/components/com_banners/helpers/banner.php';
$baseurl = JUri::base();
?>

<script type="text/javascript" src="<?php echo JURI::root() ?>modules/mod_bannerslider/assets/js/cycle.js"></script>
<script type="text/javascript">
jQuery = jQuery.noConflict();
jQuery(window).load(function() {
	jQuery('.banner_slider').cycle({ 
		fx:     '<?php echo $params->get('slideeffect')?>', 
		speed:  'slow', 
		timeout: <?php echo $params->get('timeout')?> 
		
	});
	
	<?php if($params->get('hoverstop') == 1): ?>
