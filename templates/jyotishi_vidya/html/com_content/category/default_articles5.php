		...
		<tbody>
			<?php foreach ($this->items as $i => $article) : ?>
				...
				<?php endif; ?>
					...
					<?php endif; ?>
					<td>
						<?php echo fieldattach::getFieldValue($article->id, 1, false); ?>
					</td>
					<td>
						<?php echo fieldattach::getFieldValue($article->id, 2, false); ?>
					</td>
					<td>
						<?php echo fieldattach::getFieldValue($article->id, 3, false); ?>
					</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
