...
class modMenuDropHelper
{
	 ...
	 */
	 ...
	 public static function getList(&$params)
	 {
		 ...
		 $cache		= JFactory::getCache('mod_menudrop', '');
		 if(!($items = $cache->get($key)))
		 {
			 ...
			 $items		= $params->getItems('menutype', $params->get('menutype'));
	...
	{
		// Get the base items from parameter
		if($parameter->get('base'))
		{
		...
		// Use the active menu if no base is found
		if(!$base)
		{
