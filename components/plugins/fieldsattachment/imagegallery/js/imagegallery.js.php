...
ObjImagegallery = new Class({
	...
	initialize: function(id, options) {
        ...
        { 
            ...
            jQuery('select#jform_params_galleryimage2').val(opt1); 
            jQuery("select#jform_params_galleryimage2").trigger("liszt:updated");

            jQuery('select#jform_params_galleryimage3').val(opt2); 
            jQuery("select#jform_params_galleryimage3").trigger("liszt:updated");

            jQuery('select#jform_params_gallerydescription').val(opt3); 
            jQuery("select#jform_params_gallerydescription").trigger("liszt:updated");
